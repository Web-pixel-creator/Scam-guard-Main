...
| INLINE-HUMAN-NEXT     | `@scamguard_bot что мне делать дальше?`                                      | Preview says `Что делать: остановитесь и пришлите просьбу`.                                                                             | Inserted card keeps the query and asks for the factual request before advice.                   | No generic insufficient-context preview.                                           |
