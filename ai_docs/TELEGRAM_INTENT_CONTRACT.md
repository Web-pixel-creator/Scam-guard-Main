...
13 actions x 3 languages x 4 surface variants x 8 contexts = 1,248 rows. It
distinguishes recent, orphan, stale and new-artifact behavior. The separate
legacy live matrix contains 238 end-to-end first-contact rows.
