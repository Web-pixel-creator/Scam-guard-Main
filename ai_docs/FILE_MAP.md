...
| `scripts/moderation-alert-smoke.ts`   | Safe smoke test for the optional private moderation chat; sends a clearly marked non-user alert without user evidence or secrets.                                                                                                                                                                         |
...
| `embed.check.tsx`      | `/embed/check`      | No-chrome iframe runtime for compact partner-site checks.                                           |
...
| `telegram/moderation-notifier.server.ts` | Optional private moderation Telegram alerts for new reports and appeals; sends redacted summaries plus admin links only.                                                                              |
