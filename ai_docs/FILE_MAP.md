...
| `trust/impact-stats.ts`                  | Public-stats normalizer and formatters for aggregate-only website impact counters.                                                                                           |
...
| `telegram/router.ts`                     | Telegram update router (dispatch, parseCommand, decideRoute), including direct `/call`.                                                                                      |
...
| `telegram/handlers/report.ts`            | Multi-step /report scenario, including transient screenshot evidence on the description step with no raw image persistence.                                                  |
