...
export function buildCommandPayloads(): CommandPayload[] {
  const ru: CommandPayload = {
    ...
    commands: [
      ...
      { command: "trainer", description: "Тренажёр звонков" },
      ...
      { command: "digest", description: "Схемы недели" },
  ...
  const uz: CommandPayload = {
    ...
    commands: [
      ...
      { command: "trainer", description: "Qo'ng'iroq treneri" },
      ...
      { command: "digest", description: "Haftalik sxemalar" },
  ...
  const en: CommandPayload = {
    ...
    commands: [
      ...
      { command: "trainer", description: "Call trainer" },
      ...
      { command: "digest", description: "Weekly scam digest" },
