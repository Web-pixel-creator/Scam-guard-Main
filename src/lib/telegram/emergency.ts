...
function buildLiveCallCompactCard(lang: Lang, context: LiveCallContext): string[] {
  ...
  const phrase: Record<Lang, string> = {
    ru:
      context === "relative"
        ? "«Я перезвоню тебе по сохранённому номеру»."
    ...
    const lines: Record<LiveCallContext, Record<Lang, string[]>> = {
      generic: {
        ru: [
          ...
          "",
          "«Я не обсуждаю деньги, коды, документы, карты и приложения по входящему звонку. Я перезвоню по официальному номеру или проверю всё через официальный канал.»",
          "",
      ...
      bank: {
        ru: [
          ...
          "Если человек на линии — не спорьте. Прочитайте одну фразу и завершите разговор:",
          "",
          "«Я не обсуждаю деньги, коды, карты и приложения по входящему звонку. Я перезвоню в банк по официальному номеру.»",
          "",
          "Если рядом близкий, скажите ему:",
      ...
      government: {
        ru: [
          ...
          "Если человек на линии — не спорьте. Прочитайте одну фразу и завершите разговор:",
          "",
          "«Я не передаю данные, коды, документы и платежи по входящему звонку. Я проверю запрос через официальный сайт, приложение или номер госоргана.»",
          "",
          "Если рядом близкий, скажите ему:",
      ...
      operator: {
        ru: [
          ...
          "Если человек на линии — не спорьте. Прочитайте одну фразу и завершите разговор:",
          "",
          "«Я не подтверждаю SIM, номер, коды и доступы по входящему звонку. Я перезвоню оператору по официальному номеру.»",
          "",
          "Если рядом близкий, скажите ему:",
      ...
      relative: {
        ru: [
          ...
          "",
          "«Я не перевожу деньги по срочному звонку. Я перезвоню тебе по сохранённому номеру и спрошу наше кодовое слово».",
          "",
          "Если рядом близкий, скажите ему:",
              ...
              : profile === "fake_job" ||
                ...
                : {
                    ru: [
                      ...
                      "Если человек на линии — не спорьте. Прочитайте одну фразу и завершите разговор:",
                      "",
                      "«Я не обсуждаю деньги, коды, карты и приложения по входящему звонку. Я перезвоню по официальному номеру.»",
                      "",
                      "Если рядом близкий, скажите ему:",
                      `«Ситуация: ${title}. Побудь со мной и помоги перезвонить в банк по официальному номеру — спокойно, без спешки».`,
                    ],
