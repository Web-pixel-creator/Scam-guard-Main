  ...
  head: () => ({
    meta: [
      { title: "Ishonch Guard — проверьте номер, Telegram или ссылку до того, как вас обманут" },
      {
        name: "description",
        content:
          "Бесплатный антискам-помощник для Узбекистана. Вставьте подозрительное сообщение, номер, ссылку или Telegram username — получите оценку риска и шаги, что делать.",
      },
      { property: "og:title", content: "Ishonch Guard — антискам-помощник для Узбекистана" },
      {
        property: "og:description",
        content: "Распознайте мошенников до того, как потеряете деньги.",
      },
    ...
    <div className="overflow-hidden home-stripes-bg">
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 space-y-14 md:space-y-20 lg:space-y-24 pt-3 md:pt-4">
              ...
              <div key={dup} className="flex gap-12 shrink-0">
                {{
                  ru: [
                    ...
                    "Удвоение крипты",
                    "Фейковая вакансия",
                    "Знакомство с обманом",
                  ],
                  uz: [
                    "«Xavfsiz hisob»",
                    "«Bankdan qo'ng'iroq»",
                    "Soxta ilova",
                    "SMS kodini so'rashmoqda",
                    "Telegram'da kredit",
                    "Soxta kuryer",
                    "«Sovrin yutdingiz»",
                    "Kriptoni ikki barobar",
                    "Soxta ish o'rni",
                    "Tanishuv firibgarligi",
                  ],
                  en: [
                    "«Safe account»",
                    "Fake bank call",
                  ...
                  <span
                    key={`${dup}-${i}`}
                    className="flex items-center gap-12 text-xl md:text-2xl font-sans font-medium tracking-tight text-[#71717A]"
                  >
                    {w}
        ...
        <section className="apex-frame apex-stripes border border-[#E2E0D8] rounded-[6px] p-6 sm:p-10 md:p-14 bg-white/55">
          <div className="flex items-start justify-between gap-4 mb-6">
            <span className="apex-mono">
              {{ ru: "Что мы проверяем", uz: "Nimani tekshiramiz", en: "What we check" }[lang]}
            </span>
          ...
          <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-4 md:gap-6 mb-10 md:mb-12 pb-6 md:pb-8 border-b border-[#E2E0D8]">
                ...
                {
                  {
                    ru: (
                      <>
                        Если что-то{" "}
                        <span className="font-serif-italic text-[#DC2626]">подозрительное</span> —
                        пришлите нам
                      </>
                    ),
                    uz: (
                      <>
                        Biror narsa{" "}
                        <span className="font-serif-italic text-[#DC2626]">shubhali</span> bo'lsa —
                        bizga yuboring
                      </>
                    ),
                    en: (
                      <>
                        If something feels{" "}
                        <span className="font-serif-italic text-[#DC2626]">off</span> — send it to
                        us
                      </>
                    ),
                  }[lang]
            ...
            <span className="hidden md:block apex-mono shrink-0">
              {{ ru: "4 из 4", uz: "4 / 4", en: "4 of 4" }[lang]}
            </span>
          </div>
            ...
            {[
              {
                ...
                pain: {
                  ru: "«Здравствуйте, служба безопасности банка…»",
                  uz: "«Assalomu alaykum, bank xavfsizlik xizmati…»",
                  en: "“Hello, this is the bank security service…”",
                },
                check: {
                  ru: "Сверим с базой жалоб, найдём фейковые «банки», «операторы» и звонки-обманы.",
                  uz: "Shikoyatlar bazasi bilan tekshiramiz, soxta «bank», «operator» va aldov qo'ng'iroqlarni topamiz.",
                  en: "Cross-check against our scam database, flag fake “banks”, “operators” and call scams.",
                },
              },
              {
                i: MessageSquare,
                ...
                pain: {
                  ru: "«Менеджер банка пишет в личку — просит код из SMS»",
                  uz: "«Bank menejeri shaxsiyga yozyapti — SMS kodini so'rayapti»",
              ...
              },
              {
                ...
                pain: {
                  ru: "«Оплатите доставку по этой ссылке — иначе посылку вернут»",
                  uz: "«Yetkazib berishni shu havola orqali to'lang — aks holda qaytariladi»",
              ...
              },
              {
                ...
                accent: "#F97316",
                k: {
                  ru: "Текст SMS / Telegram",
                  uz: "SMS / Telegram matni",
                  en: "SMS / Telegram text",
                },
                pain: {
                  ru: "«Срочно! По вашей карте подозрительная операция…»",
                  uz: "«Shoshilinch! Kartangizda shubhali amaliyot…»",
              ...
              <div
                key={c.k.en}
                className="relative bg-white/85 backdrop-blur-[4px] p-7 sm:p-8 md:p-10 overflow-hidden flex flex-col"
              >
        ...
        <section
          ...
          className="apex-frame apex-stripes cv-auto border border-[#E2E0D8] rounded-[6px] p-6 sm:p-10 md:p-14 bg-white/55"
        >
          <div className="flex items-start justify-between gap-4 mb-6">
            <span className="apex-mono">
              {{ ru: "Реальные примеры", uz: "Haqiqiy misollar", en: "Real examples" }[lang]}
            </span>
            <span className="apex-mono text-right">
              {{ ru: "Было → Стало", uz: "Edi → Bo'ldi", en: "Before → After" }[lang]}
            </span>
          </div>
          <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-4 md:gap-6 mb-10 md:mb-12 pb-6 md:pb-8 border-b border-[#E2E0D8]">
            <div className="max-w-3xl">
              <p className="label-md mb-4">
                03 — {{ ru: "Было / Стало", uz: "Edi / Bo'ldi", en: "Before / After" }[lang]}
              </p>
              <h2
                id="ba-title"
                className="font-sans font-medium text-[30px] sm:text-[38px] md:text-[48px] tracking-[-0.045em] leading-[1.05] text-[#18181B]"
              >
                {
                  {
                    ru: (
                      <>
                        Как выглядит <span className="font-serif-italic text-[#DC2626]">обман</span>{" "}
                        — и как должно быть на самом деле
                      </>
                    ),
                    uz: (
                      <>
                        «<span className="font-serif-italic text-[#DC2626]">Aldov</span>» qanday
                        ko'rinadi va aslida qanday bo'lishi kerak
                      </>
                    ),
                    en: (
                      <>
                        What a <span className="font-serif-italic text-[#DC2626]">scam</span> looks
            ...
            <span className="hidden md:block apex-mono shrink-0">
              {{ ru: "3 из 3", uz: "3 / 3", en: "3 of 3" }[lang]}
            </span>
          </div>
            ...
            {[
              {
                ...
                bad: {
                  ru: "СРОЧНО! По вашей карте подозрительная операция 4 500 000 сум. Если это не вы — позвоните: +998 99 412-87-03",
                  uz: "SHOSHILINCH! Kartangizda shubhali amaliyot 4 500 000 so'm. Agar bu siz bo'lmasangiz — qo'ng'iroq qiling: +998 99 412-87-03",
                  en: "URGENT! Suspicious transaction of 4,500,000 UZS on your card. If it wasn't you — call: +998 99 412-87-03",
                },
                good: {
                  ru: "Покупка 89 000 сум · Korzinka · 14:32. Баланс: 312 400 сум. Поддержка — номер на обороте карты.",
                  uz: "Xarid 89 000 so'm · Korzinka · 14:32. Hisob: 312 400 so'm. Yordam — karta orqasidagi raqam.",
                  en: "Purchase 89,000 UZS · Korzinka · 14:32. Balance: 312,400 UZS. Support — number on the back of your card.",
                },
                why: [
                  {
                    ru: "Слово «СРОЧНО» большими буквами — давление на эмоции",
                    uz: "Katta harflar bilan «SHOSHILINCH» — hissiyotga bosim",
                    en: "ALL-CAPS «URGENT» — emotional pressure",
                  },
                  {
                    ru: "Незнакомый мобильный номер вместо короткого банковского",
                    uz: "Qisqa bank raqami o'rniga notanish mobil raqam",
                    en: "Random mobile number instead of the short bank code",
                  },
                  {
                    ru: "Просят перезвонить — настоящий банк не даёт чужие номера",
                    uz: "Qayta qo'ng'iroq qilishni so'rashadi — haqiqiy bank begona raqam bermaydi",
                    en: "Asks you to call back — a real bank never gives an outside number",
                  },
                ],
              },
              {
                topic: {
                  ru: "Сообщение от «курьера»",
                  uz: "«Kuryer»dan xabar",
                  en: "Message from a “courier”",
                },
                bad: {
                  ru: "Ваша посылка не доставлена. Оплатите 27 000 сум, иначе будет возвращена: hxxp://uzpost-pay.top/track?id=8821",
                  uz: "Sizning posilkangiz yetkazilmadi. 27 000 so'm to'lang, aks holda qaytariladi: hxxp://uzpost-pay.top/track?id=8821",
                  en: "Your parcel was not delivered. Pay 27,000 UZS or it will be returned: hxxp://uzpost-pay.top/track?id=8821",
                },
                good: {
                  ru: "Посылка №RA12345UZ ожидает в отделении №7 до 12 апреля. Доплата не требуется. uzpost.uz",
                  uz: "RA12345UZ raqamli posilka 12 aprelgacha 7-bo'limda kutmoqda. Qo'shimcha to'lov shart emas. uzpost.uz",
                  en: "Parcel RA12345UZ is waiting at branch #7 until Apr 12. No extra payment needed. uzpost.uz",
                },
                why: [
                  {
                    ru: "Подозрительный домен .top вместо официального .uz",
                    uz: "Rasmiy .uz o'rniga shubhali .top domen",
                    en: "Sketchy .top domain instead of the official .uz",
                  },
                  {
                    ru: "Требование оплатить «прямо сейчас» по ссылке",
                    uz: "Havola orqali «hozir» to'lash talabi",
                    en: "Demand to pay «right now» via a link",
                  },
                  {
                    ru: "Почта никогда не просит доплату через ссылку в SMS",
                    uz: "Pochta hech qachon SMS havola orqali to'lov so'ramaydi",
                    en: "Post offices never request payment via an SMS link",
                  },
                ],
              },
              {
                topic: {
                  ru: "Telegram «менеджер банка»",
                  uz: "Telegram «bank menejeri»",
                  en: "Telegram «bank manager»",
                },
                bad: {
                  ru: "Здравствуйте, я Алишер из службы безопасности. Чтобы отменить операцию — назовите код из SMS, который пришёл сейчас.",
                  uz: "Assalomu alaykum, men xavfsizlik xizmatidan Alisherman. Amaliyotni bekor qilish uchun — hozir kelgan SMS kodni ayting.",
                  en: "Hi, I'm Alisher from security. To cancel the transaction — tell me the SMS code you just got.",
                },
                good: {
                  ru: "Банк пишет только в официальном приложении и никогда не спрашивает SMS-код. Поддержка — телефон с обратной стороны карты.",
                  uz: "Bank faqat rasmiy ilovada yozadi va hech qachon SMS-kod so'ramaydi. Yordam — karta orqasidagi telefon.",
                  en: "Banks only message you inside their official app and never ask for an SMS code. Support — the phone on the back of your card.",
                },
                why: [
                  {
                    ru: "Просит код из SMS — главный признак мошенника",
                    uz: "SMS kodni so'rayapti — firibgarning asosiy belgisi",
                    en: "Asks for an SMS code — the #1 scam signal",
                  },
                  {
                    ru: "Связь через Telegram, а не в приложении банка",
                    uz: "Bank ilovasi orqali emas, Telegram orqali bog'lanish",
                    en: "Contact via Telegram instead of the bank app",
                  },
                  {
                    ru: "Спешка — «прямо сейчас», чтобы вы не успели подумать",
                    uz: "Shoshqaloqlik — «hozir», o'ylab ko'rmasligingiz uchun",
                    en: "Hurry — «right now» so you don't have time to think",
                  },
                ],
              },
            ].map((ex, idx) => (
              <article
                key={idx}
                className="rounded-[6px] border border-[#E2E0D8] bg-white overflow-hidden flex flex-col"
              >
                ...
                <div className="px-5 pb-5">
                  <div className="inline-flex items-center gap-1.5 mb-2 text-[10.5px] font-bold tracking-[0.18em] uppercase text-[#065F46] font-mono">
                    ...
                    {
                      {
                        ru: "Стало — как настоящий",
                        uz: "Bo'ldi — haqiqiysi",
                        en: "After — the real one",
                      }[lang]
                    }
                  </div>
                ...
                <div className="mt-auto px-5 py-4 border-t border-[#E2E0D8] bg-[#FFF7ED]">
                  ...
                  <ul className="space-y-1.5">
                    {ex.why.map((w, i) => (
                      <li
                        key={i}
                        className="flex gap-2 text-[13.5px] leading-[1.55] text-[#3F1A0A]"
                      >
          ...
          <div className="mt-8 flex justify-center">
            <button type="button" onClick={scrollToForm} className="fancy-btn">
              <FancyShell>
                {
                  {
                    ru: "Проверить своё сообщение",
                    uz: "O'z xabaringizni tekshiring",
                    en: "Check your message",
                  }[lang]
                }
              </FancyShell>
            </button>
        ...
        <section className="apex-frame apex-stripes relative overflow-hidden border border-[#E2E0D8] bg-[#F4F2EB] rounded-[6px] cv-auto">
          ...
          <div className="relative p-6 sm:p-10 md:p-14">
            <div className="flex items-start justify-between gap-4 mb-6">
              <span className="apex-mono">
                {{ ru: "Как это работает", uz: "Bu qanday ishlaydi", en: "How it works" }[lang]}
              </span>
              <span className="apex-mono text-right">
                {{ ru: "3 шага", uz: "3 qadam", en: "3 steps" }[lang]}
              </span>
            </div>
            <div className="mb-10 md:mb-12 pb-6 md:pb-8 border-b border-[#E2E0D8]">
              <p className="label-md mb-4">
                03 — {{ ru: "Алгоритм", uz: "Algoritm", en: "Algorithm" }[lang]}
              </p>
              <h2 className="font-sans font-medium text-[30px] sm:text-[38px] md:text-[48px] tracking-[-0.045em] leading-[1.05] text-[#18181B] max-w-3xl text-balance">
                {t("how_it_works", lang)}
              </h2>
            </div>
              ...
              {[
                {
                  ...
                  d: t("step_1_d", lang),
                  pain: {
                    ru: "«Сомневаюсь — но времени думать нет»",
                    uz: "«Shubhalanyapman — o'ylashga vaqt yo'q»",
                    en: "“I'm suspicious — but no time to think.”",
                  },
                  out: {
                    ru: "Вставьте номер, ссылку или текст — без регистрации.",
                    uz: "Raqam, havola yoki matnni joylashtiring — ro'yxatdan o'tmasdan.",
                    en: "Paste the number, link or text — no signup.",
                  },
                },
                {
                  i: "02",
                  ...
                  d: t("step_2_d", lang),
                  pain: {
                    ru: "«Не понимаю, реально это банк или развод»",
                    uz: "«Bu haqiqiy bankmi yoki firibgarlikmi — tushunmayapman»",
                ...
                },
                {
                  ...
                  d: t("step_3_d", lang),
                  pain: {
                    ru: "«Что делать прямо сейчас?»",
                    uz: "«Hozir nima qilishim kerak?»",
                    en: "“What should I do right now?”",
                  },
                  out: {
                    ru: "Конкретные шаги: что не отправлять, кому звонить, куда писать.",
                    uz: "Aniq qadamlar: nimani yubormaslik, kimga qo'ng'iroq qilish, qayerga yozish.",
                    en: "Concrete steps: what not to send, whom to call, where to report.",
                  },
                },
              ].map((s, idx) => (
                <div
                ...
                >
                    ...
                    {
                      {
                        ...
                        uz: "Inson nimani his qiladi",
                        en: "What the user feels",
                      }[lang]
                    }
                  </div>
                  ...
                  <h3 className="font-sans text-[19px] md:text-xl font-medium tracking-tight text-[#18181B] text-balance">
                    {s.t}
                  </h3>
        ...
        <section className="apex-frame apex-stripes border border-[#E2E0D8] rounded-[6px] p-6 sm:p-10 md:p-14 bg-white/55 cv-auto">
          <div className="flex items-start justify-between gap-4 mb-6">
            <span className="apex-mono">
              {{ ru: "Пример проверки", uz: "Tekshirish misoli", en: "Check example" }[lang]}
            </span>
            <span className="apex-mono text-right">
              {{ ru: "Опасно", uz: "Xavfli", en: "Dangerous" }[lang]}
            </span>
          </div>
          <div className="text-center mb-10 md:mb-12 pb-6 md:pb-8 border-b border-[#E2E0D8]">
            <p className="label-md mb-4">
              04 — {{ ru: "Пример работы", uz: "Ish misoli", en: "Example" }[lang]}
            </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 items-stretch">
            <div className="apex-glass p-8 sm:p-10 md:p-12 rounded-[6px] flex flex-col">
              <p className="label-md mb-8">
                {{ ru: "Входящий текст", uz: "Kirish matni", en: "Incoming text" }[lang]}
              </p>

              <div className="flex-1 flex flex-col justify-center max-w-[52ch]">
                <span
                  aria-hidden
                  className="font-serif-italic text-[64px] md:text-[80px] leading-none text-[#F97316]/30 mb-2 select-none"
                >
                  “
                </span>
                  ...
                  {
                    {
                      ...
                      en: "We explain why the message looks suspicious and which exact steps to take.",
                    }[lang]
                  }
                </p>
              </div>
              ...
              <div className="relative bg-white p-8 sm:p-10 md:p-12">
                <div className="flex items-start justify-between gap-4 mb-10">
                  <div>
                    ...
                    <h3 className="font-sans text-[28px] sm:text-3xl md:text-4xl font-medium tracking-[-0.05em] text-[#18181B] leading-[1.05]">
                      {t("risk_high", lang)}
                    </h3>
                    <p className="mt-3 inline-flex items-center gap-2 px-2.5 py-1 rounded-[3px] bg-[#FEF2F2] border border-[#FCA5A5]/60 text-[#991B1B] text-[11px] font-medium tracking-[0.08em] uppercase">
                      ...
                      <span>
                        {
                          {
                            ru: "Звонок «из банка» · код из SMS",
                            uz: "«Bank»dan qo'ng'iroq · SMS kod",
                            en: "Fake bank call · SMS code",
                          }[lang]
                        }
                      </span>
                    </p>
                    ...
                    <ul className="space-y-3.5 text-[15.5px] md:text-[16.5px] text-[#18181B] leading-[1.55]">
                      {{
                        ru: [
                          ...
                          "Создают срочность и давление",
                          "Похожая схема уже в жалобах",
                        ],
                        uz: [
                          "SMS-kod (OTP) so'rashmoqda",
                          "Bank nomidan murojaat",
                          "Shoshilinchlik va bosim",
                          "Shu sxema shikoyatlarda uchragan",
                        ],
                        en: [
                          "They ask for an SMS code (OTP)",
                          "They impersonate a bank",
                          "Urgency and pressure",
                          "Similar pattern already reported",
                        ],
                      }[lang].map((r) => (
                    ...
                    <div className="space-y-2.5">
                      {{
                        ru: [
                          "Не отправляйте код",
                          "Завершите разговор",
                          "Позвоните в банк по номеру с карты",
                        ],
                        uz: [
                          "Kodni yubormang",
                          "Suhbatni tugating",
                          "Bankka kartadagi raqam orqali qo'ng'iroq qiling",
                        ],
                        en: [
                          "Don't send the code",
                          "End the call",
                        ...
                        <div
                          key={r}
                          className="flex items-center gap-4 px-4 py-3.5 rounded-[3px] bg-[#F4F2EB] border border-[#E2E0D8] text-[14px]"
                        >
        ...
        <section className="apex-frame apex-stripes border border-[#E2E0D8] rounded-[6px] p-6 sm:p-10 md:p-14 bg-white/55 cv-auto">
          <div className="flex items-start justify-between gap-4 mb-6">
            <span className="apex-mono">
              {{ ru: "Известные обманы", uz: "Ma'lum aldovlar", en: "Known scams" }[lang]}
            </span>
            <span className="apex-mono text-right">
              {{ ru: "6 из 6", uz: "6 / 6", en: "6 of 6" }[lang]}
            </span>
          </div>
          <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-4 md:gap-6 mb-10 md:mb-12 pb-6 md:pb-8 border-b border-[#E2E0D8]">
            <div className="max-w-3xl">
              <p className="label-md mb-4">
                05 — {{ ru: "База знаний", uz: "Bilimlar bazasi", en: "Knowledge base" }[lang]}
              </p>
              <h2 className="font-sans font-medium text-[30px] sm:text-[38px] md:text-[48px] tracking-[-0.045em] leading-[1.05] text-[#18181B] text-balance">
                {t("schemes_title", lang)}
              </h2>
            </div>
            <span className="hidden md:block apex-mono shrink-0">
              {{ ru: "6 случаев", uz: "6 holat", en: "6 cases" }[lang]}
            </span>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-[1px] bg-[#E2E0D8] border border-[#E2E0D8]">
            {(
              [
                {
                  n: "01",
                  ru: "«Служба безопасности банка»",
                  uz: "«Bank xavfsizlik xizmati»",
                  en: "Bank security call",
                  d_ru: "Звонят якобы из банка, говорят о подозрительной операции и просят SMS-код.",
                  d_uz: "Bank nomidan qo'ng'iroq qilib, SMS-kod so'rashadi.",
                  d_en: "They call “from the bank” and ask for your SMS code.",
                  bait_ru: "«По вашей карте подозрительная операция. Назовите код из SMS»",
                  bait_uz: "«Kartangizda shubhali amaliyot. SMS kodni ayting»",
                  bait_en: "“Suspicious activity on your card. Tell me the SMS code.”",
                  loss_ru: "Списание всей карты за минуты",
                  loss_uz: "Daqiqalarda kartadan barcha pul yo'qoladi",
                  loss_en: "Whole card drained in minutes",
                },
                {
                  n: "02",
                  ...
                  bait_ru: "«Установите это приложение для защиты счёта»",
                  bait_uz: "«Hisobni himoya qilish uchun ilovani o'rnating»",
                  bait_en: "“Install this app to protect your account.”",
                  loss_ru: "Полный доступ к SMS и банк-приложению",
                  loss_uz: "SMS va bank ilovasiga to'liq kirish",
                  loss_en: "Full access to SMS and banking apps",
                },
                {
                  n: "03",
                  ru: "Безопасный счёт",
                  uz: "Xavfsiz hisob",
                  en: "Safe account",
                  d_ru: "Уговаривают перевести деньги на «безопасный счёт». Их не существует.",
                  d_uz: "«Xavfsiz hisob»ga pul o'tkazishga undashadi.",
                  d_en: "They push you to move money to a “safe account”.",
                  bait_ru: "«Переведите деньги на безопасный счёт, пока мы блокируем мошенников»",
                  bait_uz: "«Firibgarlarni bloklaganimizcha pulni xavfsiz hisobga o'tkazing»",
                  bait_en: "“Move your money to a safe account while we block fraud.”",
                  loss_ru: "Перевод собственных денег мошенникам",
                  loss_uz: "O'z pullarini firibgarlarga o'tkazish",
                  loss_en: "Your own money sent to scammers",
                },
                {
                  n: "04",
                  ru: "Лёгкий кредит в Telegram",
                  uz: "Telegram'dagi oson kredit",
                  en: "Easy Telegram loan",
                  d_ru: "Telegram-канал обещает быстрый кредит, просит предоплату.",
                  d_uz: "Telegram kanali kredit va'da qilib oldindan to'lov so'raydi.",
                  d_en: "A Telegram channel promises a quick loan, asks a fee upfront.",
                  bait_ru: "«Кредит без проверок. Оплатите страховку — и деньги ваши»",
                  bait_uz: "«Tekshiruvsiz kredit. Sug'urtani to'lang — pul sizniki»",
                  bait_en: "“Loan with no checks. Pay the insurance fee and money is yours.”",
                  loss_ru: "Предоплата уходит, кредита нет",
                  loss_uz: "Oldindan to'lov ketadi, kredit yo'q",
                  loss_en: "Upfront fee gone, no loan",
                },
                {
                  n: "05",
                ...
                },
                {
                  ...
                  uz: "Yutuq / sovrin",
                  en: "Prize won",
                  d_ru: "Сообщают о выигрыше и просят данные карты для «зачисления».",
                  d_uz: "Yutuq haqida xabar berib karta ma'lumotlarini so'rashadi.",
                  d_en: "They claim you won and ask for card details.",
                  bait_ru: "«Вы выиграли iPhone! Введите карту для зачисления приза»",
                  bait_uz: "«Siz iPhone yutdingiz! Sovg'a uchun karta ma'lumotlarini kiriting»",
                  bait_en: "“You won an iPhone! Enter your card to receive it.”",
                  loss_ru: "Карта попадает в руки мошенников",
                  loss_uz: "Karta firibgarlar qo'liga tushadi",
        ...
        <section className="apex-frame apex-stripes border border-[#E2E0D8] rounded-[6px] p-6 sm:p-10 md:p-14 bg-white/55 cv-auto">
          <div className="flex items-start justify-between gap-4 mb-6">
            ...
            <span className="apex-mono text-right">
              {{ ru: "Реальные ситуации", uz: "Haqiqiy holatlar", en: "Real situations" }[lang]}
            </span>
          </div>
          <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-4 md:gap-6 mb-10 md:mb-12 pb-6 md:pb-8 border-b border-[#E2E0D8]">
            <div className="max-w-3xl">
                ...
                {
                  {
                    ru: (
                      <>
                        А что если{" "}
                        <span className="font-serif-italic text-[#DC2626]">уже случилось</span>?
                      </>
                    ),
                    uz: (
                      <>
                        Agar{" "}
                        <span className="font-serif-italic text-[#DC2626]">
                    ...
                    en: (
                      <>
                        What if it{" "}
                        <span className="font-serif-italic text-[#DC2626]">already happened</span>?
                      </>
                    ),
                  }[lang]
                }
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-[1px] bg-[#E2E0D8] border border-[#E2E0D8]">
            {[
              {
                q: {
                  ru: "Мне звонят из «службы безопасности банка» — это правда?",
                  uz: "Menga «bank xavfsizlik xizmati»dan qo'ng'iroq qilishyapti — bu rostmi?",
                  en: "I'm getting a call from “bank security” — is it real?",
                },
                pain: {
                  ru: "«Они знают моё имя и последние цифры карты — как такому не верить?»",
                  uz: "«Ular ismimni va karta raqamining oxirini bilishadi — qanday ishonmaslik kerak?»",
                  en: "“They know my name and last card digits — how can I not trust this?”",
                },
                ans: {
                  ru: "Настоящий банк никогда не просит SMS-код, пароль или установку приложений по ссылке. Положите трубку и перезвоните по номеру с обратной стороны карты.",
                  uz: "Haqiqiy bank hech qachon SMS-kod, parol yoki havola orqali ilova o'rnatishni so'ramaydi. Qo'ng'iroqni tugating va karta orqasidagi raqamga qo'ng'iroq qiling.",
                  en: "A real bank never asks for an SMS code, password, or app install via a link. Hang up and call the number printed on your card.",
                },
              },
              {
                q: {
                  ru: "Я уже отправил код из SMS — что делать?",
                  uz: "Men SMS kodni allaqachon yubordim — nima qilish kerak?",
                  en: "I already sent the SMS code — what now?",
                },
                pain: {
                  ru: "«Прошло 2 минуты — успею я что-то остановить?»",
                  uz: "«2 daqiqa o'tdi — biror narsani to'xtata olamanmi?»",
                  en: "“It's been 2 minutes — can I still stop something?”",
                },
                ans: {
                  ru: "Срочно позвоните в банк и попросите блокировку карты и онлайн-банка. Затем смените пароль в приложении банка и проверьте недавние операции.",
                  uz: "Zudlik bilan bankka qo'ng'iroq qiling va karta hamda onlayn-bankni bloklashni so'rang. So'ngra bank ilovasidagi parolni o'zgartiring va so'nggi amaliyotlarni tekshiring.",
                  en: "Call the bank immediately and request a card and online-banking block. Then change your banking app password and review recent transactions.",
                },
              },
              {
                q: {
                ...
                pain: {
                  ...
                  uz: "«Ilova barcha SMS va kontaktlarga ruxsat so'rayapti — bu normalmi?»",
                  en: "“The app asks for access to all my SMS and contacts — is that normal?”",
                },
                ans: {
                  ru: "Включите авиарежим, удалите приложение, смените пароли в банках через другой телефон. При необходимости сделайте сброс к заводским настройкам.",
                  uz: "Aviarejimni yoqing, ilovani o'chiring, boshqa telefon orqali bank parollarini o'zgartiring. Kerak bo'lsa, telefonni zavod sozlamalariga qaytaring.",
                  en: "Switch on airplane mode, uninstall the app, change banking passwords from a different phone. Factory-reset if needed.",
                },
              },
              {
                q: {
                  ru: "Перевёл деньги «на безопасный счёт» — можно вернуть?",
                  uz: "Pulni «xavfsiz hisob»ga o'tkazdim — qaytarib olsa bo'ladimi?",
                  en: "I sent money to a “safe account” — can I get it back?",
                },
                pain: {
                  ru: "«Перевод ушёл 10 минут назад — это уже навсегда?»",
                  uz: "«O'tkazma 10 daqiqa oldin ketgan — bu butunlay yo'qoldimi?»",
              ...
              {
                q: {
                  ru: "В Telegram пишет «менеджер банка» — отвечать?",
                  uz: "Telegram'da «bank menejeri» yozyapti — javob berishim kerakmi?",
                  en: "A “bank manager” is DMing me on Telegram — should I reply?",
                },
                pain: {
                  ru: "«У него аватарка с логотипом банка и официальное имя — выглядит настоящим»",
                  uz: "«Uning avatarida bank logotipi va rasmiy ism — haqiqiyga o'xshaydi»",
                  en: "“Their avatar has the bank logo and an official name — it looks real.”",
                },
                ans: {
                  ru: "Банки не ведут клиентскую поддержку в личных Telegram-сообщениях. Не отвечайте, пришлите username нам — проверим за секунды.",
                  uz: "Banklar shaxsiy Telegram xabarlarida mijozlarga xizmat ko'rsatmaydi. Javob bermang, username'ni bizga yuboring — soniyalarda tekshiramiz.",
                  en: "Banks don't run support over Telegram DMs. Don't reply — send the username to us, we'll check it in seconds.",
                },
              },
              {
                q: {
                  ru: "Хочу проверить ссылку, но боюсь по ней переходить",
                  uz: "Havolani tekshirmoqchiman, lekin bosishdan qo'rqyapman",
                  en: "I want to check a link but I'm scared to click it",
                },
                pain: {
                  ru: "«А вдруг это вирус, и просто открытие в браузере уже навредит?»",
                  uz: "«Agar virus bo'lsa va shunchaki brauzerda ochish allaqachon zarar yetkazsa-chi?»",
                  en: "“What if it's malware and just opening it in a browser already hurts?”",
                },
                ans: {
                  ru: "Не открывайте. Скопируйте ссылку как текст и вставьте в нашу проверку — мы анализируем её безопасно, не загружая страницу на ваш телефон.",
                  uz: "Ochmang. Havolani matn sifatida nusxalang va tekshiruvimizga joylashtiring — biz sahifani telefoningizga yuklamasdan xavfsiz tahlil qilamiz.",
                  en: "Don't open it. Copy the link as text and paste it into our checker — we analyze it safely, without loading the page on your phone.",
                },
              },
            ].map((item, idx) => (
              <details
              ...
              >
                <summary className="cursor-pointer list-none flex items-start justify-between gap-5 sm:gap-6 p-6 sm:p-7 md:p-8 focus-visible:outline-2 focus-visible:outline-offset-[-2px] focus-visible:outline-[#F97316] min-h-11">
                  <div className="flex-1 min-w-0">
                    <span className="apex-mono text-[#52525B] block mb-2">
                      {
                        {
                          ru: `Вопрос ${idx + 1}`,
                          uz: `Savol ${idx + 1}`,
                ...
                <div className="px-6 sm:px-7 md:px-8 pb-6 sm:pb-7 md:pb-8 -mt-1">
                    ...
                    {
                      {
                        ...
                        uz: "Shu daqiqada nima o'ylaysiz",
                  ...
                  <div className="mt-5 rounded-[6px] bg-[#FFF7ED] border border-[#FED7AA] p-4 md:p-5">
                    <p className="text-[11.5px] font-semibold tracking-[0.16em] uppercase text-[#C2410C] font-mono mb-2">
                      ...
                      {
                        {
                          ru: "Что делаем / что делать",
                          uz: "Nima qilamiz / nima qilish kerak",
                          en: "What we do / what you do",
                        }[lang]
                      }
                    </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-[auto_1fr] gap-6 md:gap-10 items-start">
            ...
            <div className="min-w-0">
              <p className="label-md mb-3">
                {{ ru: "Наш принцип", uz: "Bizning tamoyilimiz", en: "Our principle" }[lang]}
              </p>
              <h2
                ...
                {
                  {
                    ru: (
                      <>
                        Мы{" "}
                        <span className="font-serif-italic text-[#C2410C] mx-0.5">
                          не&nbsp;храним
                        </span>{" "}
                        ваши номера, коды и&nbsp;пароли
                      </>
                    ),
                    uz: (
                      <>
                        Biz raqamlar, kodlar va&nbsp;parollarni{" "}
                        <span className="font-serif-italic text-[#C2410C] mx-0.5">saqlamaymiz</span>
                      </>
                    ),
                    en: (
                      <>
                        We{" "}
                        <span className="font-serif-italic text-[#C2410C] mx-0.5">don't store</span>{" "}
                        your numbers, codes or&nbsp;passwords
                      </>
                    ),
                  }[lang]
                }
              ...
              <ul className="mt-7 grid grid-cols-1 sm:grid-cols-2 gap-3 md:gap-4">
                {[
                  {
                    icon: EyeOff,
                    ru: "Полные номера маскируются до проверки",
                    uz: "To'liq raqamlar tekshiruvdan oldin niqoblanadi",
                    en: "Full numbers are masked before checking",
                  },
                  {
                    icon: KeyRound,
                    ru: "OTP-коды и пароли никогда не сохраняются",
                    uz: "OTP kodlar va parollar hech qachon saqlanmaydi",
                    en: "OTP codes and passwords are never saved",
                  },
                  {
                    icon: ImageOff,
                    ru: "Скриншоты не уходят в базу — только текст без PII",
                    uz: "Skrinshotlar bazaga tushmaydi — faqat shaxsiy ma'lumotsiz matn",
                    en: "Screenshots never reach our DB — only redacted text",
                  },
                  {
                    icon: UserX,
                    ru: "Регистрация не нужна — никаких профилей",
                    uz: "Ro'yxatdan o'tish shart emas — profil yo'q",
                    en: "No signup, no profiles, no tracking",
                  },
                ].map(({ icon: Icon, ...item }) => (
                  <li
                    key={item.en}
              ...
              <div className="mt-7 flex flex-wrap items-center gap-x-5 gap-y-3 pt-5 border-t border-dashed border-[#E2E0D8]">
                ...
                >
                  <span className="underline underline-offset-4 decoration-[#FED7AA] group-hover:decoration-[#F97316]">
                    {
                      {
                        ru: "Полная политика приватности",
                        uz: "To'liq maxfiylik siyosati",
                ...
                <span className="apex-mono text-[#A1A1AA]">
                  ...
                  {
                    {
                      ru: "соответствует GDPR-практикам",
                      uz: "GDPR amaliyotiga mos",
                      en: "GDPR-aligned",
                    }[lang]
                  }
                </span>
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-[1fr_1.4fr] gap-8 md:gap-12 items-start">
            <div>
              <p className="apex-mono mb-3">
                {{ ru: "Сообщество", uz: "Hamjamiyat", en: "Community" }[lang]}
              </p>
              <h2
                ...
                {
                  {
                    ru: (
                      <>
                        Ваша жалоба{" "}
                        <span className="font-serif-italic text-[#C2410C]">защищает тысячи</span>
                      </>
                    ),
                    uz: (
                      <>
                        Sizning shikoyatingiz{" "}
                        <span className="font-serif-italic text-[#C2410C]">
                          minglarni himoya qiladi
                        </span>
                      </>
                    ),
                    en: (
                      <>
                        Your report{" "}
                        <span className="font-serif-italic text-[#C2410C]">protects thousands</span>
                      </>
                    ),
                  }[lang]
                }
        ...
        <section
          ...
          className="apex-frame border border-[#FCA5A5]/60 rounded-[6px] p-6 sm:p-8 md:p-10 bg-[#FFF7ED] cv-auto"
        >
              ...
              {
                {
                  ...
                  uz: "Agar allaqachon yuz bergan bo'lsa — darhol qo'ng'iroq qiling",
                  en: "If it already happened — call now",
                }[lang]
              }
            </span>
            <span className="apex-mono text-right hidden sm:block">
              {
                {
                  ru: "Каждая минута важна",
          ...
          <h2
            ...
            className="font-sans font-medium text-[26px] sm:text-3xl md:text-[36px] tracking-[-0.04em] leading-[1.1] text-[#18181B] mb-6 md:mb-8 text-balance"
          >
            {
              {
                ru: "Срочные телефоны — нажмите, чтобы позвонить",
                uz: "Shoshilinch telefonlar — qo'ng'iroq qilish uchun bosing",
                en: "Emergency phones — tap to call",
              }[lang]
            }
          </h2>
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 md:gap-4">
            {[
              ...
              >
                ...
                <ArrowRight
                  aria-hidden="true"
                  className="h-4 w-4 text-[#A1A1AA] group-hover:text-[#F97316] group-hover:translate-x-0.5 transition-all"
                  strokeWidth={2}
                />
              </a>
            ))}
          ...
          <p className="mt-5 text-[13.5px] text-[#52525B] leading-[1.55] text-pretty">
            ...
            >
              {
                { ru: "Открыть инструкцию →", uz: "Ko'rsatmani ochish →", en: "Open the guide →" }[
                  lang
                ]
              }
            </Link>
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-2 pb-16">
          <div className="apex-shell">
            <div className="relative bg-white p-7 sm:p-9 md:p-11 overflow-hidden">
              <div className="flex items-center justify-between mb-6">
                <span className="label-md text-[#F97316]">
                ...
                {
                  {
                    ...
                    en: "If you already sent an SMS code, installed an APK or transferred money — every minute counts.",
                  }[lang]
                }
              </p>
          ...
          <div className="relative bg-[#F4F2EB] border border-[#E2E0D8] rounded-[6px] p-7 sm:p-9 md:p-11 overflow-hidden">
            ...
            <h3 className="font-sans text-[28px] sm:text-3xl md:text-4xl font-medium tracking-[-0.05em] leading-[1.05] mb-5 text-[#18181B] text-balance">
              {
                {
                  ru: "Помогите защитить других",
                  uz: "Boshqalarni himoya qiling",
                  en: "Help protect others",
                }[lang]
              }
            </h3>
            <p className="text-[#3F3F46] text-[16px] md:text-[17px] leading-[1.7] mb-8 max-w-[44ch] text-pretty">
              {
                {
                  ...
                  en: "Every report is moderated and helps the system learn and warn thousands.",
                }[lang]
              }
            </p>
        ...
        <footer className="apex-frame apex-stripes border-t border-[#E2E0D8] mt-4 pt-12 sm:pt-16 pb-8 -mx-6 px-6 sm:px-10 md:px-14">
            ...
            <div className="space-y-1.5">
              <p className="apex-mono flex items-center gap-2">
                <ShieldCheck
                  aria-hidden="true"
                  focusable="false"
                  className="h-3.5 w-3.5 text-[#F97316] shrink-0"
                  strokeWidth={1.5}
                />
          ...
          <div className="flex flex-wrap items-center justify-center gap-x-3 gap-y-2 label-md text-center mb-12 sm:mb-16">
            ...
            <span>
              {
                {
                  ru: "Без сохранения · За секунды · Бесплатно",
                  uz: "Saqlanmaydi · Soniyalarda · Bepul",
                  en: "No storage · In seconds · Free",
                }[lang]
              }
            </span>
            <Sparkles
              ...
              {
                {
                  ...
                  en: "ISHONCH GUARD — ANTI-FRAUD HELPER FOR UZBEKISTAN",
                }[lang]
              }
            </p>
      ...
      >
        ...
        >
          <FancyShell showArrow={false}>
            {
              {
                ru: "Проверить номер или ссылку",
                uz: "Raqam yoki havolani tekshirish",
                en: "Check a number or link",
              }[lang]
            }
            <ArrowDown className="h-4 w-4" strokeWidth={2} />
          </FancyShell>
