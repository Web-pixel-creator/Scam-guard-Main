# Telegram Weekly Scam Digest v1 Tasks

- [x] 1. Create spec and implementation plan
- [x] 2. Add digest formatter and compact keyboard
- [x] 3. Add `/digest` command and callback routing
