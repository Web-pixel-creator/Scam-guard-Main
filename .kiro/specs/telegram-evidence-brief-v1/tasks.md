...
- [x] 1. Add a scenario-first Telegram brief builder inside the public metadata enrichment layer.
- [x] 2. Expand Telegram next-step text for account takeover and credential/official-looking scenarios.
- [x] 3. Reorder enriched Telegram explanations so scenario/action appears before generic Bot API limitations.
