...
3. WHEN a screenshot contains NFT/Stars/gift/giveaway plus vote/captcha/reaction/subscribe actions, THE builder SHALL surface enough context for `giveaway_engagement_bait`, `fake_captcha_or_voting`, and/or `task_reward_engagement_bait`.
...
1. Unit tests SHALL cover Twin/Tonplay free-spins, TON NFT/Stars giveaway, task reward campaign, wallet urgency, TON referral earning, betting invite, and ordinary news/product negative cases.
