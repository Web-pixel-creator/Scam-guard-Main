# Tasks: Telegram Video Thumbnail Intelligence v1

- [x] 1. Model Telegram video thumbnail evidence in the update schema.
- [x] 2. Route video thumbnails to the existing image pipeline when no stronger textual evidence exists.
- [x] 3. Preserve current caption/link/button priority and unsupported-video fallback.
